...
class SubscriptionAbility
{
     ...
     *
     * @var \Logicalcrow\PricingPlans\Models\PlanSubscription
     */
    ...
    {
        /** @var \Logicalcrow\PricingPlans\Models\PlanSubscriptionUsage $usage */
    ...
    public function value(string $featureCode, $default = null)
    {
        ...
        /** @var \Logicalcrow\PricingPlans\Models\Feature $feature */
